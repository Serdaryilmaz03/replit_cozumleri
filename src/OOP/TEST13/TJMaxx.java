...
public class TJMaxx {
    ...
    public void removeItem(int catalogNumber) {
        ...
        for (int j = 0; j < regularItems.size(); j++) {
            if (regularItems.get(j).getCatalogNumber() == catalogNumber) {
                regularItems.remove(j);
                j--;
            }
    ...
    public void buyItem(int catalogNumber) {
        ...
        for (int j = 0; j < regularItems.size(); j++) {
            if (regularItems.get(j).getCatalogNumber() == catalogNumber) {
                regularItems.get(j).setQuantity(regularItems.get(j).getQuantity() - 1);
                if (regularItems.get(j).getQuantity() == 0) {
                    regularItems.remove(j);
