...
public class Color {
    ...
    public String toString() {
        if (Arrays.equals(WHITE, rgb)) {
            return "white";
        } else if (Arrays.equals(RED, rgb)) {
            return "red";
        } else if (Arrays.equals(YELLOW, rgb)) {
            return "yellow";
        } else if (Arrays.equals(GRAY, rgb)) {
            return "gray";
        } else if (Arrays.equals(rgb,BLACK)) {
            return "black";
        } else if (Arrays.equals(DARK_GRAY, rgb)) {
            return "dark gray";
        } else if (Arrays.equals(LIGHT_GRAY, rgb)) {
            return "light gray";
        } else if (Arrays.equals(BLUE, rgb)) {
            return "blue";
        } else if (Arrays.equals(ORANGE, rgb)) {
            return "orange";
        } else if (Arrays.equals(CYAN, rgb)) {
            return "cyan";
        } else if (Arrays.equals(PINK, rgb)) {
            return "pink";
        } else if (Arrays.equals(GREEN, rgb)) {
            return "green";
        } else if (Arrays.equals(MAGENTA, rgb)) {
            return "magenta";
        } else {
            return "n/a";
        }
